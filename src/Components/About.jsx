  ...
  return (
    <div className="py-4 px-6 bg-black h-auto" id="about">
      ...
      <div className="flex flex-col md:flex-row items-center md:space-x-20">
        <div className="w-60 h-52 rounded bg-[url('/Image/Pic.png')] bg-cover bg-no-repeat mb-8 md:mb-0 mx-10"></div>
        ...
        <div className="space-y-4">
            ...
            <div className="flex items-center gap-x-4">
              ...
              <div className="w-10/12 h-2.5 rounded-full bg-gray-700">
                <div className="h-2.5 bg-gradient-to-r from-green-400 to-blue-500 w-[50%] rounded-full transition-transform duration-300 hover:scale-105"></div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-x-4">
            <label className="w-2/12 text-white">Tailwind CSS</label>
              <div className="w5 rounded-full bg-gray-700">
          ...
          <div className=" flex flex-cols-1 md:grid-cols-3 gap-4">
