...
const Contact = () => {
  return (
    <div className="py-12 px-6 bg-black h-screen" id="contact">
        ...
        <form className="space-y-4">
          <div className="flex flex-col text-left">
            ...
            <input
              ...
              className="bg-slate-400 px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400"
            />
          </div>

          <div className="flex flex-col text-left">
            <label className=" border-gray-400 text-white">Message</label>
            <textarea
              placeholder="Enter your message"
              className="bg-gray-400 px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400"
              rows="4"
            />
          </div>
          ...
          <div className="flex flex-col text-left">
            ...
            <input
              ...
              className="bg-slate-400 px-4 py-2 border border-gray-300 rounded-lg"
            />
          </div>
